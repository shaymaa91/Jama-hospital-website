...
<html lang="en">
	...
	<head>
		...
		<link href="/metronic/theme/html/demo1/dist/assets/css/pages/login/classic/login-5.css?v=7.1.8" rel="stylesheet" type="text/css" />
		<!--end::Page Custom Styles-->
		<!--begin::Global Theme Styles(used by all pages)-->
		<link href="/metronic/theme/html/demo1/dist/assets/plugins/global/plugins.bundle.css?v=7.1.8" rel="stylesheet" type="text/css" />
		<link href="/metronic/theme/html/demo1/dist/assets/plugins/custom/prismjs/prismjs.bundle.css?v=7.1.8" rel="stylesheet" type="text/css" />
		<link href="/metronic/theme/html/demo1/dist/assets/css/style.bundle.css?v=7.1.8" rel="stylesheet" type="text/css" />
		<!--end::Global Theme Styles-->
		<!--begin::Layout Themes(used by all pages)-->
		<link href="/metronic/theme/html/demo1/dist/assets/css/themes/layout/header/base/light.css?v=7.1.8" rel="stylesheet" type="text/css" />
		<link href="/metronic/theme/html/demo1/dist/assets/css/themes/layout/header/menu/light.css?v=7.1.8" rel="stylesheet" type="text/css" />
		<link href="/metronic/theme/html/demo1/dist/assets/css/themes/layout/brand/dark.css?v=7.1.8" rel="stylesheet" type="text/css" />
		<link href="/metronic/theme/html/demo1/dist/assets/css/themes/layout/aside/dark.css?v=7.1.8" rel="stylesheet" type="text/css" />
		<!--end::Layout Themes-->
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<script src="/metronic/theme/html/demo1/dist/assets/plugins/global/plugins.bundle.js?v=7.1.8"></script>
		<script src="/metronic/theme/html/demo1/dist/assets/plugins/custom/prismjs/prismjs.bundle.js?v=7.1.8"></script>
		<script src="/metronic/theme/html/demo1/dist/assets/js/scripts.bundle.js?v=7.1.8"></script>
		<!--end::Global Theme Bundle-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="/metronic/theme/html/demo1/dist/assets/js/pages/custom/login/login-general.js?v=7.1.8"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>