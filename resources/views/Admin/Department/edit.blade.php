...
@section("title-side")
<!--a href="{{asset('admin/Department/create')}}" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air">
    <span>
...
<div class="m-portlet m-portlet--mobile px-4 py-3">
    <form method="post" action="{{asset('admin/Department/'.$item->id)}}">
        @csrf
        @method("put")
        <div class='m-form'>
            <div class="m-portlet__body">
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="title" value="{{$item->title}}" class="form-control m-input" placeholder="ادخل الاسم ">
                ...
                <div class="m-form__actions m-form__actions">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <a href="{{asset('admin/Department')}}" class="btn btn-secondary">الغاء الامر</a>
                        </div>
                    </div>
                </div>
            </div>
