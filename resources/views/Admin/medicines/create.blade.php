...
<div class="m-portlet m-portlet--mobile px-4 py-3">
    <form method="post" action='{{route("medicines.index")}}'>
        @csrf
        <div class='m-form'>
            <div class="m-portlet__body">
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control m-input" placeholder="ادخل اسم الدواء"
                                name="midicine_name" value='{{ old("midicine_name") }}'>
                        </div>
                    </div>
                    ...
                    <div class="m-form__group form-group row">
                        <label class=" col-lg-3 col-form-label">متوفر / غير متوفر</label>
                        <div class="m-radio-inline col-lg-6">
                            <label class="m-radio m-radio--solid m-radio--brand">
                                <input {{old('status')=='1'?"checked":""}} type="radio" name="status" checked=""
                                    value="1" aria-describedby="account_group-error"> متوفر                                <span></span>
                            </label>
                            <label class="m-radio m-radio--solid m-radio--brand">
