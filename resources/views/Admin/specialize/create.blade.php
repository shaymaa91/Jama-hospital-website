...
@section("title-side")
<!--a href="{{asset('admin/Specialize/create')}}" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air">
    <span>
...
<div class="m-portlet m-portlet--mobile px-4 py-3">
    <form method="post" action='{{route("Specialize.index")}}'>
        @csrf
        <div class='m-form'>
                ...
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <span class="m-form__help">أدخل اسم التخصص</span>
                        </div>
                    </div>
                ...
                <div class="m-form__actions m-form__actions">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <a href="{{asset('admin/Specialize')}}" class="btn btn-secondary">الغاء الامر</a>
                        </div>
                    </div>
                </div>
            </div>
