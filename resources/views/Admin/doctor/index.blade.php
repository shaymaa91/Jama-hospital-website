...
@section("title-side")
<a href="{{route('doctor.create')}}" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air">
    <span>
                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td><img src='{{asset("storage/images/$item->image")}}' alt="new-arrivals images"
