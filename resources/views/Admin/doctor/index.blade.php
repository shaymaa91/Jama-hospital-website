            ...
            <div class="row">
                ...
                <div class='col-4'>
                    ...
                    <input type="submit" class='btn btn-secondary' value='مسح البحث'
                        onclick="document.getElementById('q').value = ''; document.getElementById('department').value = ''; document.getElementById('stats').value = ''; return true;" />
                </div>
                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td><img height=50 width= 50 src='{{asset("storage/assets/img/{$doctor->image}")}}' alt=""></td>
                                <td width="15%">
                                    ...
                                    <a class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only"
                                        ...
                                        onclick="return confirm('هل انت متأكد من حذف {{$doctor->name}} ؟')" title="حذف"><i
